...
//IntroParagraph variable creates a link to refrece 
...
//Folegandros variable creates a link to refrece 
var Folegandros = document.getElementById("Folegandros");
console.log(Folegandros.textContent);
...
//Alonissos variable creates a link to refrece 
var Alonissos = document.getElementById("Alonissos");
console.log(Alonissos.textContent);
...
//Spetses variable creates a link to refrece 
var Spetses = document.getElementById("Spetses");
console.log(Spetses.textContent);
...
//Amorgos variable creates a link to refrece 
var Amorgos = document.getElementById("Amorgos");
console.log(Amorgos.textContent);
...
//Syros variable creates a link to refrece 
var Syros = document.getElementById("Syros");
console.log(Syros.textContent);
...
//Milos variable creates a link to refrece 
var Milos = document.getElementById("Milos");
console.log(Milos.textContent);
...
//Hydra variable creates a link to refrece 
var Hydra = document.getElementById("Hydra");
console.log(Hydra.textContent);
...
console.log(Ithaca.textContent);
...
console.log(Gavdos.textContent);
